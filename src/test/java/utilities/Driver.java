...
public class Driver {
    ...
    /*
    Page Object Model'de (POM) Driver için TestBase class'ina extends etmek yerine
    Driver class'indan static method'lar kullanarak driver olusturup, ilgili ayarlarin yapilmasi
